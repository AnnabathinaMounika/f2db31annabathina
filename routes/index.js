...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Wardrobe App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Wardrobe App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Wardrobe App Login', user : req.user }); 
}); 
